    ...
    return (
        <div id='navbar' className='flex justify-between py-5 items-center'>
            ...
            <div className='gap-5 lg:gap-10 flex items-center cursor-pointer'>
                ...
                <button onClick={() => setShowLogin(true)} className='py-1 px-4 lg:py-2 lg:px-7 text-sm md:text-base bg-transparent text-slate-700 border border-orange-600 rounded-full hover:bg-orange-50 transition duration-300 ease-in-out'>
                    Entrar
                </button>
            </div>
        </div>
